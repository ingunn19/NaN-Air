...
class UI_API:
    ...
    def set_WorkTrip(self, arrivingAt, aircraftID, pilot1, pilot2, flightAttendant1, flightAttendant2, flightAttendant3):
        ...
        self.__logic_API.set_workTrip(set_workTrip_list)
    ...
    def set_Destination(self, airportID, destination, contact_name, contact_number):
        ...
        self.__logic_API.set_destination(set_destination_list)

    # Get overview
    def get_all_employees(self):
        print("All employees")
        __all_employee_list = self.__logic_API.view_all_employees()
    ...
    def get_personal_info(self, employee):
        print('Employee Info')
        employee_info_list = self.__logic_API.view_employee_details(employee)
    ...
    def get_work_schedule(self, employee, year, week):
        ...
        __employee_work_week_list = self.__logic_API.view_employee_work_week(employee, year, week)
    ...
    def get_all_pilots(self):
        ...
        __pilots_list = self.__logic_API.view_all_pilots()
    ...
    def get_all_cabin_crew(self):
        ...
        __cabin_crew_list = self.__logic_API.view_all_cabin_crew()
    ...
    def get_day_with_task(self, task_day):
        ...
        __working_employees_list = self.__logic_API.view_working_today(task_day)
    ...
    def get_day_no_task(self, task_day):
        ...
        __available_employees_list = self.__logic_API.view_available_today(task_day)
        print('Employee Id: ', end="")
    ...
    def get_airplane_licence(self, model):
        ...
        __pilots_with_licence_list = self.__logic_API.view_all_with_licence_on_model(model)
    ...
    def get_pilot_licence(self):
        ...
        __all_licences_list = self.__logic_API.view_all_pilot_licences()
    ...
    def get_all_worktrips(self):
        print("All worktrips")
        __all_work_trips_list = self.__logic_API.view_all_work_trips()
    ...
    def get_week_worktrip(self, year, week):
        ...
        __work_week_list = self.__logic_API.view_work_week(year, week)
    ...
    def get_day_worktrip(self, display_workday):
        ...
        __work_day_list = self.__logic_API.view_work_day(display_workday)
    ...
    def get_specific_worktrip(self, flight_number):
        ...
        __work_trip_info_list = self.__logic_API.view_single_worktrip(flight_number)
    ...
    def get_all_destinations(self):
        ...
        __all_destinations_list = self.__logic_API.view_all_destinations()
    ...
    def get_specific_destination(self, a_destination):
        ...
        __destination_info_list = self.__logic_API.view_single_destination(a_destination)
    ...
    def get_all_planes(self):
        print("All airplane")
        __all_airplanes_list = self.__logic_API.view_all_planes()
    ...
    def get_specific_aircraft(self, plane_insignia):
        ...
        __airplane_info_list = self.__logic_API.view_single_airplane(plane_insignia)
    ...
    def get_plane_state(self):
        ...
        __state_of_airplanes_list = self.__logic_API.view_state_of_planes(date)
