...
# Add new
def check_add_employee(__employee_info):
...
def check_add_destination(__destination_info):
...
# Overview
def check_view_employee_week(__employee_id, __week):
    if validate.check_if_employee_exists(__employee_id):
        if 1 <= int(__week) <= 52:
            return True
    return None

def check_date(__date):
    try:
...
# Edit existing
def check_edit_employee(__employee_info):
    pass

def check_edit_airplane(__airplane_info):
    pass

def check_edit_worktrip(__worktrip_info):
    pass

def check_edit_contact(__destination_info):
    pass
